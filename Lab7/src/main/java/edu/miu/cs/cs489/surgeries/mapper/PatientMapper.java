...
import edu.miu.cs.cs489.surgeries.dto.response.PatientResponseDto2;
...
public interface PatientMapper {
    ...
    Patient patientResponseDtoToPatient(PatientResponseDto patientResponseDto);

    Patient patientResponseDto2ToPatient(PatientResponseDto2 patientResponseDto2);
}
